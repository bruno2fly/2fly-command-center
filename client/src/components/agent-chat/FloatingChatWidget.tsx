      ...
      <AnimatePresence>
        {(!panelOpen || minimized) && (
          <motion.button
            ...
            className="fixed bottom-6 right-6 z-50 w-14 h-14 rounded-full bg-[#013E99] text-white shadow-lg hover:scale-110 transition-transform flex items-center justify-center focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-offset-2 focus:ring-offset-[#0f172a] relative"
      ...
      <AnimatePresence>
        {panelOpen && !minimized && (
          <motion.div
            ...
            className={`fixed z-50 flex flex-col border shadow-2xl backdrop-blur-xl sm:rounded-2xl sm:bottom-6 sm:right-6 inset-0 w-full h-full sm:inset-auto sm:w-[380px] sm:h-[500px] ${panelBg} ${panelBorder}`}
